...
python scripts/render_single.py --scene_file dambreak.blend --input_dir config/outputs_sph_water/show_frames_10mps
...
python scripts/render_single.py --scene_file Landscape.blend --input_dir config/outputs_simulate_mpm3_1/show_frames

python scripts/render_single.py --scene_file dambreak.blend --input_dir config/outputs_simulate_mpm2/show_frames

python scripts/render_single.py --scene_file dambreak.blend --input_dir config/outputs_simulate_mpm_nailong_1/show_frames

python scripts/render_single.py --scene_file dambreak.blend --input_dir config/outputs_simulate_mpm0/show_frames
